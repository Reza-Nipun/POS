<div class="pull-left breadcrumb_admin clear_both">
      ...
      <div class="container clear_both padding_fix">
        ...
        <form role="form" class="form-horizontal" action="<?php echo base_url(); ?>access/update_category_info" method="post">
        ...
        <div class="porlets-content">
            <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                      <input type="text" name="category_name" id="category_name" value="<?php echo $category_info[0]['category_name']?>" class="form-control" required />
                      <input type="hidden" name="id" id="id" value="<?php echo $category_info[0]['id']?>" class="form-control" required readonly />
                  </div>
                </div>
                </div>
                <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                      <input type="text" name="category_description" id="category_description" value="<?php echo $category_info[0]['category_description']?>" class="form-control" required />
                  </div>
                </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <select name="status" id="status" class="form-control" required>
                                ...
                                <option value="1" <?php if($category_info[0]['status'] == 1){ ?> selected="selected" <?php } ?>>Active</option>
                                <option value="0" <?php if($category_info[0]['status'] == 0){ ?> selected="selected" <?php } ?>>Inactive</option>
                            </select>
                        </div>
                    </div>
                </div>
