<div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Product Vendor Return</h1>
          <h2 class="">Product Return...</h2>
        </div>
      ...
      <div class="container clear_both padding_fix">
        ...
        <form role="form" class="form-horizontal" action="<?php echo base_url();?>access/product_vendor_return_save" method="post">
                    ...
                    <div class="col-md-12" id="tableWrap">
                        <table class="table table-scroll table-striped" border="1" id="prod_code_tbl">
                           ...
                           <tfoot>
                               <tr>
                                   <td colspan="4"></td>
                                   <td class="center"><h5><b>Total</b></h5></td>
                                   <td class="center" align="center"><input class="" style="width: 180px;" readonly type="text" name="total_price" id="total_price" value="" /></td>
                                   <td></td>
                               </tr>
<!--                               <tr>-->
<!--                                   <td colspan="4"></td>-->
...
<!--                               </tr>-->
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-1">
                        <button type="submit" name="submit_btn" id="submit_btn" class="btn btn-success">Return</button>
                    </div>
                    <div class="col-md-1">
        ...
        if(code != '' && code_length == 10 && last_variable == '.'){
            ...
            if(find_data < 0){
               ...
               $.ajax({
                    async: false,
                    type: "POST",
                    url: "<?php echo base_url();?>access/getProductInfoByCodeReturn/",
